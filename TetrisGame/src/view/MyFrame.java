...
//		JMenuItem ji1=new JMenuItem("开局（O）");
		...
		JMenuItem ji4=new JMenuItem("作者");
		ji4.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				JDialog dl=new Version(MyFrame.this,"人员信息",false);
...
//		jt2.setEditable(false);
		jt2.setOpaque(false);
//		JTextField jt4=new JTextField("变形：空格" );
		JLabel jt4=new JLabel("变形：空格");
		jt4.setFont(new Font("宋体", Font.BOLD, 15));
//		jt4.setEditable(false);
		jt4.setOpaque(false);
//		JTextField jt5=new JTextField("向左：←" );
		JLabel jt5=new JLabel("向左：←");
		jt5.setFont(new Font("宋体", Font.BOLD, 15));
//		jt5.setEditable(false);
		jt5.setOpaque(false);
//		JTextField jt6=new JTextField("向右：→" );
		JLabel jt6=new JLabel("向右：→");
		jt6.setFont(new Font("宋体", Font.BOLD, 15));
//		jt6.setEditable(false);
		jt6.setOpaque(false);
//      JTextField jt7=new JTextField("一键到底：↓" );		
		JLabel jt11=new JLabel("一键到底：↓");
		jt11.setFont(new Font("宋体", Font.BOLD, 15));
//		jt6.setEditable(false);
		jt6.setOpaque(false);
//		JTextField jt7=new JTextField("暂停：P" );
		JLabel jt7=new JLabel("暂停：P");
		jt7.setFont(new Font("宋体", Font.BOLD, 15));
//		jt7.setEditable(false);
		jt7.setOpaque(false);
//		JTextField jt8=new JTextField("继续：o" );
		JLabel jt8=new JLabel("继续：o");
		jt8.setFont(new Font("宋体", Font.BOLD, 15));
